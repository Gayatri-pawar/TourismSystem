...
<body class="bg-secondary">
  ...
  <div class="search-results"></div>
    ...
    <div class="logout container pt-5 text-center ">
        <h1 class="text-warning">You have been logged out</h1>
        <p>Thank you for using our service. We hope to see you again soon!</p>
        <div class="mt-4">
            <a href="index.jsp" class="btn btn-primary">Home</a>
            <a href="customer.jsp" class="btn btn-primary">Customer Dashboard</a>
                <a href="adminbefore.jsp" class="btn btn-primary">Admin Dashboard</a>
        </div>
    </div>
<!-- 
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min"></script> -->
