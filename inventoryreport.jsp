...
<button class="btn btn-secondary  dropdown-toggle  d-none d-lg-block" data-bs-toggle="dropdown" aria-expanded="false">
 ...
 PreparedStatement ps = conn1.prepareStatement("Select * from inventory");
 ResultSet rs = ps.executeQuery();
 out.println("<div class='m-5 pt-5')");
 out.println("<div class='table-responsive '>");

 out.println("<table class='table table-bordered table-hover table-warning table-light  shadow table-striped '> <tr> <th class='fw-bold'>inventory_no</th>   <th>inventory_type</th>   <th>inventory_name</th>   <th>Description</th>  <th>Availability</th>  </tr>");
 
 while(rs.next()){
int srNo = rs.getInt("inventory_no");
	   String Name1 = rs.getString("inventory_type");
	   String Email1 = rs.getString("inventory_name");
	   String Pass1 = rs.getString("Description"); 
	    String role = rs.getString("Availability");
	  
      out.println("<tr>  <td>"+srNo+" </td>   <td>"+Name1+"</td>   <td>"+Email1+"</td> <td>"+Pass1+"</td> <td>"+role+"</td>  </tr>");
