...
<div class="justify-content-center d-flex mx-5">
    ...
    <li class="text-decoration-none mx-3 fw-bold fs-5 dropdown-toggle text-white d-none d-lg-block" data-bs-toggle="dropdown" aria-expanded="false">Home</li>
   
    <li class="text-decoration-none mx-3 fw-bold fs-5 text-white  d-none d-lg-block">Tour Packages</li>
    <li class="text-decoration-none mx-3 fw-bold fs-5 text-white  d-none d-lg-block">Destination</li>
    <li class="text-decoration-none mx-3 fw-bold fs-5 text-white  d-none d-lg-block">Gallery</li>
    <li class="text-decoration-none mx-3 fw-bold fs-5 text-white  d-none d-lg-block">Price</li>
    <li class="text-decoration-none mx-3 fw-bold fs-5 text-white  d-none d-lg-block">Feedback</li>
    <li class="text-decoration-none mx-4 fw-bold fs-5 text-white  d-none d-lg-block">Login</li>
</ul>
...
<button class="btn btn-secondary  dropdown-toggle  d-none d-lg-block" data-bs-toggle="dropdown" aria-expanded="false">
  ...
  <div>
    <div class="background ">
        ...
        <p class="text-center"><a href="/destinations" class="btn btn-success">Discover Destinations</a></p>
        
    </div>
  </div>

     <h3 class="mx-5 p-3 text-center text-danger">What TechoHub brings to the table </h3>
     <div>
        ...
        <div class="card-body">
          <h5 class="card-title">
            <video autoplay muted loop class="w-100 h-100">
              <source src="images/4125025-uhd_3840_2160_24fps.mp4 " >
            </video>
          </h5>
    ...
    <div class="col-12 col-lg-4 col-md-6">
      <div class="card m-3 card_second img-fluid" style="width: 20rem;">
        <div class="card-body">
          <h5 class="card-title">
          <video autoplay muted loop class="w-100 h-100">
            <source src="images/16668409-uhd_3840_2160_24fps.mp4">
          </video>
          </h5>
    ...
    <div class="col-12 col-lg-4 col-md-6">
      <div class="card m-3 card_second img-fluid" style="width: 20rem;">
        <div class="card-body">
          <h5 class="card-title">
            <video autoplay muted loop class="w-100 h-100">
              <source src="images/2257010-uhd_3840_2160_24fps.mp4">
            </video>
          </h5>
    ...
    <div class="col-12 col-lg-4 col-md-6">
      <div class="card m-3 card_second img-fluid" style="width: 20rem;">
        <div class="card-body">
          <h5 class="card-title">
            <video autoplay muted loop class="w-100 h-100">
              <source src="images/4763824-sd_426_240_24fps (3).mp4 " >
            </video>
          </h5>
    ...
    <div class="col-12 col-lg-4 col-md-6">
      <div class="card m-3 card_second img-fluid" style="width: 20rem;">
        <div class="card-body">
          <h5 class="card-title">
          <video autoplay muted loop class="w-100 h-100">
            <source src="images/2867873-uhd_3840_2160_24fps.mp4">
          </video>
          </h5>
    ...
    <div class="col-12 col-lg-4 col-md-6">
      <div class="card m-3 card_second img-fluid" style="width: 20rem;">
        <div class="card-body">
          <h5 class="card-title">
            <video autoplay muted loop class="w-100 h-100">
              <source src="images/3115221-hd_1920_1080_24fps.mp4">
            </video>
          </h5>
          <h6 class="card-subtitle mb-2 text-white fw-bold">Easy to use trip planning tools</h6>
          <p class="card-text text-white">With useful tools like trip planner, flight tracker and bag measure. 
   ...
   <div class="col-12 col-lg-6 pb-3 ">
    <div class="accordion" id="accordionExample">
      <div class="accordion-item">
        <h2 class="accordion-header">
          <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
            How can I find the cheapest flight using TechnoHub?  
          </button>
        </h2>
        <div id="collapseOne" class="accordion-collapse collapse show" data-bs-parent="#accordionExample">
          <div class="accordion-body">
    ...
    <div class="col-12 col-lg-3 col-md-6">
      ...
      <div class="col-12 col-lg-3 col-md-6 ">
        ...
        <div class="col-12 col-lg-3 col-md-6  ">
          ...
          <p class="text-center pt-5">Copyright by TechnoHub </p>
  </div>
 </div>
