...
<body class="gallery bg-secondary">
    <div>
...
<button class="btn btn-secondary  dropdown-toggle  d-none d-lg-block" data-bs-toggle="dropdown" aria-expanded="false">
  ...
  <div>
    <main class="container gallery-container">
        <h1 class="text-center pt-5 text-warning">Gallery</h1>
        <p class="text-center pb-5 text-warning fs-3">Explore beautiful moments captured during our tours.</p>
        
        <div class="row">
            <div class=" col-12 col-lg-4 col-md-4 gallery-item">
                <img src="Assets/images/pexels-hakan-hu-1301084-2480554.jpg" alt=" Image 1" class="h-50">
                <h5 class="pt-3">12 janeuary 2012 </h5>
            </div>
            <div class=" col-12 col-lg-4 col-md-4 gallery-item">
                <img src="Assets/images/pexels-pixabay-207896.jpg" alt="Gallery Image 2"   class="h-50">
                <h5 class="pt-3">10 April 2010 </h5>
            </div>
            <div class=" col-12 col-lg-4 col-md-4 gallery-item">
                <img src="Assets/images/pexels-d-ng-nhan-324384-2888108.jpg" alt="Gallery Image 3" class="h-50">
                <h5 class="pt-3">15 March 2015 </h5>
            </div>
        ...
        <div class="row">
            <div class="col-12 col-lg-4 col-md-4 gallery-item">
                <img src="Assets/images/pexels-tirachard-kumtanom-112571-887828.jpg" alt="Gallery Image 1" class="h-75">
                <h5 class="pt-3">20 December 2010 </h5>
            </div>
            <div class=" col-12 col-lg-4 col-md-4 gallery-item">
                <img src="Assets/images/pexels-vladyslav-dukhin-296649.jpg" alt="Gallery Image 2"   class="h-75">
                <h5 class="pt-3"> 6 janeuary 2006 </h5>
            </div>
            <div class=" col-12 col-lg-4 col-md-4 gallery-item">
                <img src="Assets/images/pexels-brettjordan-4031833.jpg" alt="Gallery Image 3" class="h-75">
                <h5 class="pt-3"> 31 February 2006 </h5>
            </div>
