      ...
      <%
       ...
       PreparedStatement ps = conn1.prepareStatement(
   		    ...
   		    "where registration.Name = review.reviewer_name"
        		 ...
        		 out.println("<p class='text-warning fs-1 text-center'>Reviews's Data : </p>");
        		 out.println("<div class='table-responsive '>");

        		 out.println("<table class='table table-bordered table-hover table-warning table-light  shadow table-striped '> <tr>    <th>Name</th>   <th>email</th>   <th>Review_no</th>  <th>Reviewer_name</th> <th>Rating</th> <th>Comment</th>  </tr>");
