...
public class inventory extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		 ...
		 try {
			 ...
			 PreparedStatement ps = con.prepareStatement("insert into inventory(inventory_type,inventory_name,Description,Availability) values(?,?,?,?)");
			 ps.setString(1,type);
			 ps.setString(2, name);
			 ...
			 ps.executeUpdate();
			  ...
			  PrintWriter out = response.getWriter();
			   ...
			   out.println("<p class='text-warning bg-light m-5 p-5 shadow text-center fs-2'>Inventory Submitted</p>");
