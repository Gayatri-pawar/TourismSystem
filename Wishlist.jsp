...
<button class="btn btn-secondary  dropdown-toggle  d-none d-lg-block" data-bs-toggle="dropdown" aria-expanded="false">
  <i class="bi bi-gear"></i></button>
    <ul class="dropdown-menu">
        ...
        <li><a class="dropdown-item" href="Orders.jspl">Orders</a></li>   
...
<div class="container wishlist-container">
    <h1 class="text-center my-4 fs-3 text-danger pt-5" >My Wishlist</h1>
    <div class="table-responsive">
        <table id="wishlist-table" class="table table-hover table-striped table-bordered border-primary">
            <thead>
                <tr>
            ...
            <tbody>
                <tr>
                    <td>Paris, France</td>
                    <td>The City of Light, known for its art, fashion, and culture.</td>
                    <td>
                         <a href='wishlistremove.jsp' class="btn btn-danger btn-sm remove-button">Remove</a>
                        <a href="Booking.jsp" class="btn btn-primary btn-sm book-button">Book Now</a>
                    </td>
                </tr>
                <tr>
                    <td>Tokyo, Japan</td>
                    <td>A bustling metropolis known for its modern architecture, shopping, and food.</td>
                    <td>
                        <a href='wishlistremove.jsp' class="btn btn-danger btn-sm remove-button">Remove</a>
                   <a href="Booking.jsp" class="btn btn-primary btn-sm book-button">Book Now</a>
                    </td>
                ...
                <tr>
                    <td>New York, USA</td>
                    <td>The city that never sleeps, known for its iconic landmarks and vibrant culture.</td>
                    <td>  
                     <a href='wishlistremove.jsp' class="btn btn-danger btn-sm remove-button">Remove</a>
                        <a href="Booking.jsp" class="btn btn-primary btn-sm book-button">Book Now</a>
                    </td>
                ...
                <tr>
                    ...
                    <td>Famous for its Sydney Opera House, Harbour Bridge, and beautiful beaches.</td>
                    <td>
                        <a href='wishlistremove.jsp' class="btn btn-danger btn-sm remove-button">Remove</a>
                       <a href="Booking.jsp" class="btn btn-primary btn-sm book-button">Book Now</a>
                    </td>
                ...
                <tr>
                    <td>Rome, Italy</td>
                    <td>Known for its nearly 3,000 years of globally influential art, architecture, and culture.</td>
                    <td>
                        <a href='wishlistremove.jsp' class="btn btn-danger btn-sm remove-button">Remove</a>
                      <a href="Booking.jsp" class="btn btn-primary btn-sm book-button">Book Now</a>
                    </td>
